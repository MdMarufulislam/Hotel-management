...
id="navigation" class="navbar navbar-toggleable-md fixed-top navbar-light bg-faded site-navigation">
				...
				<div class="collapse navbar-collapse justify-content-end" id="navbarCollapse">
					<nav>
						<ul class="navbar-nav">
						  ...
						  <!-- Login Button -->
						  <li><a class="btn btn-success" href="pass-login.php">Logout</a></li>
						</ul>
					</nav>
				</div> 
			</div><!--- END CONTAINER -->
