...
<?php
	session_start();
	include('ticket-book/assets/inc/config.php');
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="ticket-book/assets/lib/perfect-scrollbar/css/perfect-scrollbar.css"/>
    <link rel="stylesheet" type="text/css" href="ticket-book/assets/lib/material-design-icons/css/material-design-iconic-font.min.css"/>
    <link rel="stylesheet" href="ticket-book/assets/css/app.css" type="text/css"/>
  </head>
  <body class="be-splash-screen">
    ...
    <script src="ticket-book/assets/lib/jquery/jquery.min.js" type="text/javascript"></script>
    <script src="ticket-book/assets/lib/perfect-scrollbar/js/perfect-scrollbar.min.js" type="text/javascript"></script>
    <script src="ticket-book/assets/lib/bootstrap/dist/js/bootstrap.bundle.min.js" type="text/javascript"></script>
    <script src="ticket-book/assets/js/app.js" type="text/javascript"></script>
    <script src="ticket-book/assets/js/swal.js"></script>
